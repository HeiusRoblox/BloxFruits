...
local QuestUI = PlayerGui.Main.Quest
    ...
    while task.wait() do
        if _G.AutoLevel then
            pcall(function()
                ...
                local hasQuest = QuestUI.Visible and string.find(QuestTitle.Text, NameMon)
                ...
                if not hasQuest then
                    ...
                    if (CFrameQ.Position - playerPos).Magnitude <= 5 then
                    ...
                    -- Di chuyển đến điểm spawn nếu không thấy quái
                    for _, spawnPoint in pairs(Workspace._WorldOrigin.EnemySpawns:GetChildren()) do
                        if string.find(spawnPoint.Name, NameMon) then
                            local distance = (LocalPlayer.Character.HumanoidRootPart.Position - spawnPoint.Position).Magnitude
                            if distance >= 10 then
...
local SecStats = v16.Player:AddSection("Auto Stats");
local v107 = v16.Player:AddToggle("ToggleMelee", {
    Title = "Nâng Đấm",
    Description = "",
    Default = false
});
...
local v108 = v16.Player:AddToggle("ToggleDe", {
    Title = "Nâng Máu",
    Description = "",
    Default = false
});
...
local v109 = v16.Player:AddToggle("ToggleSword", {
    Title = "Nâng Kiếm",
    Description = "",
    Default = false
});
...
local v110 = v16.Player:AddToggle("ToggleGun", {
    Title = "Nâng Súng",
    Description = "",
    Default = false
});
...
local v111 = v16.Player:AddToggle("ToggleFruit", {
    Title = "Nâng Trái",
    Description = "",
    Default = false
});
...
local PVPSection = v16.Player:AddSection("PVP Section");
local v112 = {};
...
local v56 = v16.Player:AddSection("Misc");
...
local FruitSection = v16.Fruit:AddSection("Fruit Section");
...
local RaidSection = v16.Fruit:AddSection("Raid Section");
local v136 = {
    "Flame",
    "Ice",
    "Quake",
...
local v137 = v16.Fruit:AddDropdown("DropdownRaid", {
    Title = "Chọn Chip",
    Description = "",
    Values = v136,
    Multi = false,
...
local v138 = v16.Fruit:AddToggle("ToggleBuy", {
    Title = "Mua Chip",
    Description = "",
    Default = false
});
...
local v139 = v16.Fruit:AddToggle("ToggleStart", {
    Title = "Bắt Đầu Raid",
    Description = "",
    Default = false
});
...
local v140 = v16.Fruit:AddToggle("ToggleNextIsland", {
...
local v141 = v16.Fruit:AddToggle("ToggleAwake", {
    Title = "Thức Tỉnh",
    Description = "",
    Default = false
});
...
local v142 = v16.Fruit:AddToggle("ToggleGetFruit", {
...
local v56 = v16.Fruit:AddSection("Tập Kích Law");
local v143 = v16.Fruit:AddToggle("ToggleLaw", {
