...
local Window = Library:MakeWindow({
  ...
  SaveFolder = "MinzCute | Blox Fruits.lua"
})
local Discord = Window:MakeTab({
  Title = "Tab Infomantion",
  Icon = "Info"
})
...
ImageButton.Image = "rbxassetid://134589506605546"
...
Discord:AddDiscordInvite({
    Name = "HeiusDev | Community",
    Description = "Discord Của Bố Híu Nhé=))",
    Logo = "rbxassetid://134589506605546",
    Invite = "https://discord.gg/ZMHKHu9DQ"
})
local Codes = {
    "WildDares",
    "BossBuild",
