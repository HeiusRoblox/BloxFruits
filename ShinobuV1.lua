local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/HeiusRoblox/UiLibrary/refs/heads/main/Fluent-Shinobu.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))()

local Window = Fluent:CreateWindow({
    Title = "Shinobu X Hub [ Version 1.0 ]",
    SubTitle = "by Heius",
    TabWidth = 160,
...
local Tabs = {
	Info = Window:AddTab({ Title = "Tab Infomantion", Icon = "info" }),
    Main = Window:AddTab({ Title = "Tab Farming", Icon = "home" }),
    Setting = Window:AddTab({ Title = "Settings Farm", Icon = "settings" }),
...
Info:AddParagraph({
    Title = "Owner Hub: HeiusYeager",
    Content = ""
})
Info:AddParagraph({
    Title = "Owner UI: HeiusYeager",
    Content = ""
})
Info:AddParagraph({
    Title = "Support Game: Blox Fruits",
    Content = ""
})
Info:AddParagraph({
    Title = "Crack: Hiru Hub ^^",
    Content = ""
})
Info:AddParagraph({
    Title = "Thanks for using my hub <3 ",
    Content = ""
})
...
_G.FastAttack = true    
  ...
  local ToggleHop = Tabs.Main:AddToggle("ToggleHop", {Title = "Tìm sever có rip_indra", Default = false })
    ToggleHop:OnChanged(function(Value)
        _G.Hop = Value
    end)
    Options.ToggleLevel:SetValue(false)
loadstring(Game:HttpGet("https://raw.githubusercontent.com/avu73923/HoangHub/refs/heads/main/Timripindra"))()
      end
   end
end
...
Camera:Stop()
HeiusFast = Tabs.Setting:AddToggle("Toggle", {
    Title = "Super Fast Attack",
    Default = false,
    Callback = function(FastValue)
        if FastValue then
            loadstring(game:HttpGet("https://raw.githubusercontent.com/HeiusRoblox/Settings/refs/heads/main/FastAttack.lua"))()
        end
    end
})
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://77062123649925"
