...
PosY = 50
local Main = Tabs.Main:AddSection("Main Farm")
...
spawn(function()
	while wait(0.05) do -- TÄƒng tá»‘c Ä‘á»™ táº¥n cÃ´ng báº±ng cÃ¡ch giáº£m thá»i gian chá»
		module:attack()
	end
end)
...
UseCode("STRAWHATMAINE")
local Toggle = Tabs.Sg:AddToggle("Auto Clickï¸", {
	Title = "Auto Click",
	Description = "",
	Default = true,
	Callback = function(Value)
...
local Toggle = Tabs.Q:AddToggle("Auto Swords", {
...
local Toggle = Tabs.Q:AddToggle("Auto Koko [ Fully ]", {
	Title = "Auto Koko",
	Description = "",
	Default = false,
	Callback = function(Value)
...
local Toggle = Tabs.Q:AddToggle("Auto Buy Legendary Sword", {
...
local Toggle = Tabs.Q:AddToggle("Auto Buy True Triple Katana", {
...
local Toggle = Tabs.Q:AddToggle("Auto Tushita", {
	Title = "Auto Tushita",
	Description = "",
	Default = false,
	Callback = function(Value)
...
local Toggle = Tabs.Q:AddToggle("Auto Yama", {
	Title = "Auto Yama",
	Description = "",
	Default = false,
	Callback = function(Value)
...
local Toggle = Tabs.Q:AddToggle("Auto Hallow Scythe [ Fully ]", {
...
local Toggle = Tabs.Q:AddToggle("Auto Skull Guitar", {
...
local Toggle = Tabs.Q:AddToggle("Auto Cursed Dual Katana", {
...
local Toggle = Tabs.Q:AddToggle("Auto Rip Indra", {
		...
		pcall(function()
			if _G.AutoObservation then
				...
				if target then
					...
					local flyPosition = targetPosition + Vector3.new(0, 20, 0) -- à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡à¹€à¸«à¸™à¸·à¸­à¸¨à¸±à¸•à¸£à¸¹
					Tween(CFrame.new(targetPosition))
					repeat
						task.wait()
						if not player.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
							game:GetService('VirtualUser'):CaptureController()
							game:GetService('VirtualUser'):SetKeyDown('0x65') -- à¸à¸” E à¹€à¸žà¸·à¹ˆà¸­à¹€à¸›à¸´à¸” Haki
							wait(2)
...
local Volcano = Tabs.S:AddParagraph({
	Title = "Volcano Island : Hasnâ€™t Spawn âŒï¸",
})
spawn(function()
	pcall(function()
		while wait() do
			if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
				Volcano:SetTitle("volcano island: Has Spawn âœ…ï¸");
			else
				Volcani:SetTitle("volcano island: Hasnâ€™t Spawn âŒï¸");
			end
		end
	end)
end)
local Elite = Tabs.S:AddParagraph({
	Title = "Status : Hasnâ€™t Spawn âŒ",
})
spawn(function()
	while task.wait() do
		pcall(function()
			if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
				Elite:SetTitle("Elit Hunter: Has Spawn! âœ…")
			else
				Elite:SetTitle("Elit Hunter : Hasnâ€™t Spawn âŒ")
			end
		end)
	end
end)
local EliteProgress = Tabs.S:AddParagraph({
...
local KilledCheck = Tabs.S:AddParagraph({
...
local BoneCheck = Tabs.S:AddParagraph({
	...
	while wait() do
		if _G.AutoFindMoon then
			...
			elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
				...
				game.StarterGui:SetCore("SendNotification", {
					Title = "Notification",
					Text = "Not Find FullMoon Letâ€™s Hop" ,
					Icon = "http://www.roblox.com/asset/?id=95800489232564",
					Duration = 2.5
				})
