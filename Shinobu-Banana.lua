...
t12 = Window:AddTab({ Title = "Tab Shop", Icon = "" })
t12:AddParagraph({
    Title = "Melee Shop :",
    Content = ""
})
...
t1 = Window:AddTab({ Title = "Tab Status & Server", Icon = "" })
...
t2 = Window:AddTab({ Title = "Tab Farming", Icon = "" })
...
t3 = Window:AddTab({ Title = "Settings Farm", Icon = "" })
t3:AddParagraph({
...
t5 = Window:AddTab({ Title = "Tab Stats", Icon = "" })
...
t7 = Window:AddTab({ Title = "Tab Volcanic Event", Icon = "" })
t7:AddParagraph({
...
t8 = Window:AddTab({ Title = "Tab Upgrade Race", Icon = "" })
t8:AddParagraph({
...
t10 = Window:AddTab({ Title = "Tab Sea Event", Icon = "" })
...
t11 = Window:AddTab({ Title = "Tab Other Sea", Icon = "" })
t11:AddParagraph({
        Title = "Kitsune Event :",
        Content = ""
    })    
...
t13 = Window:AddTab({ Title = "Tab Teleport", Icon = "" })
t13:AddParagraph({
...
t14 = Window:AddTab({ Title = "Tab Misc", Icon = "" })
t14:AddParagraph({
    Title = "soon",
    Content = ""
})
