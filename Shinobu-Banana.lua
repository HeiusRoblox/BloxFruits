...
ImageLabel.Image = "rbxassetid://77062123649925"
...
local Window = Fluent:CreateWindow({
    Title = "Shinobu X Hub [ Banana-Version ]",
    SubTitle = "by Heius,",
    TabWidth = 160,
...
t0 = Window:AddTab({ Title = "#Infomantion:", Icon = "" })
t0:AddParagraph({
...
t2 = Window:AddTab({ Title = "#MainFarming", Icon = "" })
...
t3 = Window:AddTab({ Title = "#FarmSettings", Icon = "" })
t3:AddParagraph({
...
t35 = Window:AddTab({ Title = "#SkillSettings", Icon = "" })
t35:AddParagraph({
...
t4 = Window:AddTab({ Title = "#Stack-Other Farm", Icon = "" })
t4:AddParagraph({
...
t5 = Window:AddTab({ Title = "#PlayerStats", Icon = "" })
...
t6 = Window:AddTab({ Title = "#Get-Buy Item", Icon = "" })
t6:AddParagraph({
     Title = "Auto Get :",
     Content = ""
})
...
t7 = Window:AddTab({ Title = "#Event-Volcanic", Icon = "" })
t7:AddParagraph({
...
t8 = Window:AddTab({ Title = "#UpgradeRace", Icon = "" })
t8:AddParagraph({
...
t9 = Window:AddTab({ Title = "#Fruit-Raid", Icon = "" })
t9:AddParagraph({
    Title = "Raids",
    Content = ""
})
...
t10 = Window:AddTab({ Title = "#Event-Sea", Icon = "" })
...
t11 = Window:AddTab({ Title = "#SeaSettings", Icon = "" })
t11:AddParagraph({
        Title = "Kitsune Event :",
        Content = ""
    })    
