...
Window = Fluent:CreateWindow({
    Title = "Heius Roblox-Blox Fruit [ Free ]", --- Đổi thành tên script các bạn muốn
    SubTitle = "by Hieudz", --- Đổi "Name" thành tên của các bạn
    TabWidth = 155,
...
ImageLabel.Image = "rbxassetid://93834040274817" -- thay id vào đây
